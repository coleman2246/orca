...
export const CORE_COMMAND_SPECS: CommandSpec[] = [
  ...
  },
  {
    ...
    usage:
      'orca worktree create --name <name> [--repo <selector>|--project <id> [--host <host-id>]|--project-host-setup <id>] [--agent <id>] [--prompt <text>] [--setup run|skip|inherit] [--base-branch <ref>] [--issue <number>] [--linear-issue <identifier-or-url>] [--gitea-issue <number-or-url>] [--comment <text>] [--parent-worktree <selector>] [--no-parent] [--run-hooks] [--activate] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'repo',
      'project',
    ...
    examples: [
      ...
      'orca worktree create --repo id:<repoId> --name gitea-task --gitea-issue 42 --json',
  ...
  },
  {
    ...
    usage:
      'orca worktree set --worktree <selector> [--display-name <name>] [--issue <number|null>] [--linear-issue <identifier-or-url|null>] [--gitea-issue <number-or-url|null>] [--comment <text>] [--workspace-status <id>] [--parent-worktree <selector>|--no-parent] [--json]',
    allowedFlags: [
      ...GLOBAL_FLAGS,
      'worktree',
      'display-name',
    ...
    notes: [
      ...
      'Pass --gitea-issue null to clear the Gitea issue link.'
    ],
    examples: [
      'orca worktree set --worktree active --linear-issue STA-335 --json',
      'orca worktree set --worktree active --linear-issue null --json',
      'orca worktree set --worktree active --gitea-issue 42 --json',
      'orca worktree set --worktree active --gitea-issue null --json'
    ]
  },
  {
    path: ['worktree', 'rm'],
